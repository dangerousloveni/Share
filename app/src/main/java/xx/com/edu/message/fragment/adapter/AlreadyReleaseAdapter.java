...
public class AlreadyReleaseAdapter  extends BaseAdapter {
    ...
    private String[] txtthem=new String[] {"微信解封","快递兼职","发单兼职"};
    private String[] txtContent=new String[]{"微信解封30元一单，需要的联系我",
    ...
    public AlreadyReleaseAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        AlreadyReleaseAdapter.ViewHolder viewHolder;
        if(convertView==null)
        {
            convertView=View.inflate(mContext, R.layout.new_item,null);
            viewHolder=new AlreadyReleaseAdapter.ViewHolder();
            ...
            viewHolder= (AlreadyReleaseAdapter.ViewHolder) convertView.getTag();
        }
